...
public class TestLexerExec extends BaseTest {
	...
	public void testEOFSuffixInFirstRule_1() throws Exception {
		...
		this.input ="";
		this.expectedOutput = "[@0,0:-1='<EOF>',<-1>,1:0]\n";
		this.expectedErrors = "";
		generateLexerTest("L.g4", grammar, "L", false);
	...
	public void testLargeLexer() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(89822);
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("WS : [ \\t\\r\\n]+ -> skip;\n");
	...
	public void testNonGreedyConfigs() throws Exception {
		...
		grammarBuilder.append("I : .*? ('a' | 'ab') {console.log(this.text);} ;\n");
		grammarBuilder.append("WS : (' '|'\\n') -> skip ;\n");
		grammarBuilder.append("J : . {console.log(this.text);};");
		String grammar = grammarBuilder.toString();
	...
	public void testPositionAdjustingLexer() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(2576);
		grammarBuilder.append("lexer grammar PositionAdjustingLexer;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@members {\n");
		grammarBuilder.append("public nextToken(): Token {\n");
		grammarBuilder.append("	if (!(this._interp instanceof PositionAdjustingLexerATNSimulator)) {\n");
		grammarBuilder.append("		this._interp = new PositionAdjustingLexerATNSimulator(PositionAdjustingLexer._ATN, this);\n");
		grammarBuilder.append("	}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("	return super.nextToken();\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("public emit(): Token {\n");
		...
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("private handleAcceptPositionForIdentifier(): boolean {\n");
		grammarBuilder.append("	let tokenText = this.text;\n");
		grammarBuilder.append("	let identifierLength = 0;\n");
		grammarBuilder.append("	while (identifierLength < tokenText.length && PositionAdjustingLexer.isIdentifierChar(tokenText[identifierLength])) {\n");
		grammarBuilder.append("		identifierLength++;\n");
		grammarBuilder.append("	}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("	if (this.inputStream.index > this._tokenStartCharIndex + identifierLength) {\n");
		grammarBuilder.append("		let offset = identifierLength - 1;\n");
		grammarBuilder.append("		this.interpreter.resetAcceptPosition(this._input, this._tokenStartCharIndex + offset, this._tokenStartLine, this._tokenStartCharPositionInLine + offset);\n");
		...
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("private handleAcceptPositionForKeyword(keyword: string): boolean {\n");
		grammarBuilder.append("	if (this.inputStream.index > this._tokenStartCharIndex + keyword.length) {\n");
		...
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("get interpreter(): PositionAdjustingLexerATNSimulator {\n");
		grammarBuilder.append("	return super.interpreter as PositionAdjustingLexerATNSimulator;\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("private static isIdentifierChar(c: string): boolean {\n");
		grammarBuilder.append("	return /^[a-zA-Z0-9_]$/.test(c);\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@beforeLexer {\n");
		grammarBuilder.append("import { Token } from \"antlr4ts\";\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@afterLexer {\n");
		grammarBuilder.append("export class PositionAdjustingLexerATNSimulator extends LexerATNSimulator {\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("	constructor(atn: ATN, recog: Lexer) {\n");
		grammarBuilder.append("		super(atn, recog);\n");
		grammarBuilder.append("	}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("	public resetAcceptPosition(input: CharStream, index: number, line: number, charPositionInLine: number): void {\n");
		...
		this.expectedOutput = 
			...
			"[@9,53:52='<EOF>',<-1>,7:0]\n";
		this.expectedErrors = "";
		generateLexerTest("PositionAdjustingLexer.g4", grammar, "PositionAdjustingLexer", false);
	...
	@Test
	public void testUnicodeCharSet() throws Exception {
		mkdir(tmpdir);

		StringBuilder grammarBuilder = new StringBuilder(63);
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("ID : ([A-Z_]|'Ā'..'�') ([A-Z_0-9]|'Ā'..'�')*;");
		String grammar = grammarBuilder.toString();
