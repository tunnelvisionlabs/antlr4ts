...
export class TestCodePointCharStream {
	...
	public emptyBytesHasSize0(): void {
		let s: CodePointCharStream = CharStreams.createWithString("");
	...
	public singleLatinCodePointHasSize1(): void {
		let s: CodePointCharStream = CharStreams.createWithString("X");
	...
	public multipleLatinCodePointsLookAheadShouldReturnCodePoints(): void {
		let s: CodePointCharStream = CharStreams.createWithString("XYZ");
		assert.strictEqual("X".charCodeAt(0), s.LA(1));
		assert.strictEqual(0, s.index);
	...
	public singleCJKCodePointHasSize1(): void {
		let s: CodePointCharStream = CharStreams.createWithString("\u611B");
		assert.strictEqual(1, s.size);
		assert.strictEqual(0, s.index);
	}
	...
	public singleEmojiCodePointHasSize1(): void {
		let s: CodePointCharStream = CharStreams.createWithString(String.fromCodePoint(0x1F4A9));
		assert.strictEqual(1, s.size);
		assert.strictEqual(0, s.index);
	}
	...
	public getTextWithLatin(): void {
		let s: CodePointCharStream = CharStreams.createWithString("0123456789");
		assert.strictEqual("34567", s.getText(Interval.of(3, 7)));
	}

	@test
	public getTextWithCJK(): void {
		let s: CodePointCharStream = CharStreams.createWithString("01234\u40946789");
		assert.strictEqual("34\u409467", s.getText(Interval.of(3, 7)));
	}

	@test
	public getTextWithEmoji(): void {
		let s: CodePointCharStream = CharStreams.createWithString("01234" + String.fromCodePoint(0x1F522) + "6789");
